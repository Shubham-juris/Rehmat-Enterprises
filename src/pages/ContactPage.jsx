...
const ContactPage = () => {
  return (
    <section className="relative py-24 text-gray-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
            viewport={{ once: true }}
            className="bg-black/40 backdrop-blur-xl p-8 rounded-xl border border-white/10 shadow-xl"
          >
          ...
          >
            {/* Contact Information */}
            <div className="bg-black/40 backdrop-blur-xl p-8 rounded-xl border border-white/10 shadow-xl">
              <h3 className="text-2xl font-bold text-green-400 mb-6">
                Contact Information
              </h3>
            ...
            {/* Google Map */}
            <div className="w-full h-64 md:h-80 rounded-xl overflow-hidden border border-gray-700 shadow-xl">
              <iframe
                title="company-map"
                width="100%"
                height="100%"
